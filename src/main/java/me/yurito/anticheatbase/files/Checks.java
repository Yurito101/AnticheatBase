...
public class Checks implements Initializer {
    ...
    public enum Setting {
        ...
        AIM_H("aim.h", true, "Should we enable this module?"),
        AIM_I("aim.i", true, "Should we enable this module?"),
        AIM_J("aim.j", true, "Should we enable this module?"),
        AIM_K("aim.k", true, "Should we enable this module?"),
        AIM_L("aim.l", true, "Should we enable this module?"),
        AIM_M("aim.m", true, "Should we enable this module?"),
